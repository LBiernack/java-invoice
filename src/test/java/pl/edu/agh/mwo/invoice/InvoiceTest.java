...
public class InvoiceTest {
    ...
    public void testPrintInvoiceWithOneProducts() {
        ...
        String text = "Faktura nr: " + invoice.getInvoiceNumber() + "; data wystawienia: " + invoice.getCreationDate() + "\n"
                ...
                + "Cena jedn. brutto [PLN]: 200,00; Liczba: 1; Wartość brutto [PLN]: 200,00\n"
                + "Liczba pozycji: 1\n"
                + "Razem: Wartość Netto [PLN]: 200,00; Wartość VAT + Akcyza [PLN]: 0,00; Wartość Brutto [PLN]: 200,00";
    ...
    public void testPrintInvoiceWithOneProductsWithQuantityMoreThanOne() {
        ...
        String text = "Faktura nr: " + invoice.getInvoiceNumber() + "; data wystawienia: " + invoice.getCreationDate() + "\n"
                ...
                + "Liczba pozycji: 1\n"
                + "Razem: Wartość Netto [PLN]: 1000,00; Wartość VAT + Akcyza [PLN]: 80,00; Wartość Brutto [PLN]: 1080,00";
        invoice.printInvoice();
        Assert.assertEquals(text, outputStreamCaptor.toString()
                .trim());
    ...
    public void testPrintInvoiceWithManyProductsExciseTaxNoDiscount() {
        ...
        try (MockedStatic<LocalDate> mockedStatic = Mockito.mockStatic(LocalDate.class)) {
            ...
            String text = "Faktura nr: " + invoice2.getInvoiceNumber() + "; data wystawienia: " + "2024-03-16\n"
                    ...
                    + "Nazwa: Kubek; Cena jedn. netto [PLN]: 5,00; Stawka VAT: 0%; Cena jedn. brutto [PLN]: 5,00; Liczba: 2; Wartość brutto [PLN]: 10,00\n"
                    + "Nazwa: Pinezka; Cena jedn. netto [PLN]: 0,01; Stawka VAT: 23%; Cena jedn. brutto [PLN]: 0,0123; Liczba: 1000; Wartość brutto [PLN]: 12,30\n"
                    ...
                    + "Liczba pozycji: 5\n"
                    + "Razem: Wartość Netto [PLN]: 240,00; Wartość VAT + Akcyza [PLN]: 187,40; Wartość Brutto [PLN]: 427,40";
    ...
    public void testPrintInvoiceWithManyProductsExciseTaxDiscount() {
        ...
        try (MockedStatic<LocalDate> mockedStatic = Mockito.mockStatic(LocalDate.class)) {
            ...
            String text = "Faktura nr: " + invoice2.getInvoiceNumber() + "; data wystawienia: " + "2024-03-05\n"
                    ...
                    + "Nazwa: Wino; Cena jedn. netto [PLN]: 10,00; Stawka VAT: 23%; Akcyza [PLN]: 5,56; Cena jedn. brutto [PLN]: 17,86; Liczba: 10; Wartość brutto [PLN]: 178,60\n"
                    + "Liczba pozycji: 5\n"
                    + "Razem: Wartość Netto [PLN]: 240,00; Wartość VAT + Akcyza [PLN]: 104,00; Wartość Brutto [PLN]: 344,00";
